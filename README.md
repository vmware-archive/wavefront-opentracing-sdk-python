...
* If you have already set up a `WavefrontSender` for another SDK that runs in the same process, use that one.

* Otherwise, [Set Up a Wavefront Sender](https://github.com/wavefrontHQ/wavefront-sdk-python#set-up-a-wavefront-sender).
